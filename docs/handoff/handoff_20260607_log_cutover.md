...
작성 2026-06-07 / 최종갱신 2026-06-09 / 브랜치 **preview** (프로덕션 main 미머지) / **상태: 029 적용 + 코드 컷오버 1~4단계 + 입력 폼 디자인 다듬기 전부 완료·프리뷰 푸시 (디자인 2026-06-09 마무리). 잔여=5단계(표시면 평탄화)·030 cleanup·main 머지·스토리 연결.**
