...
export const BLOCK_TYPES: BlockTypeDef[] = [
  ...
  { id: "hot-bath", blockType: "hot-bath", label: "온탕", labelEn: "HOT BATH", icon: "heat", category: "heat", durUnit: "min", cacheCol: "hot_bath_temp", tempRange: [30, 43], tempSteps: [ { value: 30, label: "미지근" }, { value: 37, label: "따뜻" }, { value: 39, label: "적당" }, { value: 40, label: "뜨끈" }, { value: 42, label: "뜨겁" } ] },
