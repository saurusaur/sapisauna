...
export const BLOCK_TYPES: BlockTypeDef[] = [
  ...
  { id: "salt-sauna", blockType: "salt-sauna", label: "소금사우나", icon: "salinity", category: "heat", durUnit: "min", cacheCol: "salt_sauna_temp", tempRange: [40, 70], tempSteps: [ { value: 40, label: "미온" }, { value: 55, label: "적당" }, { value: 70, label: "뜨끈" } ] },
