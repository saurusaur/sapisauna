...
export default function StoryEdit() {
  ...
  const typeEmojis: Record<string, string> = { bather: '🛁', saunner: '🔥', jimi: '🥚' }
  const typeNames: Record<string, string> = { bather: '목욕파', saunner: '사우너파', jimi: '찜질파' }
        ...
        <div className="mb-6">
          <div className={`${styles.bg} rounded-2xl p-6 shadow-lg aspect-[9/16] max-h-[400px] flex flex-col justify-center`}>
            ...
            <div className="text-center mb-4">
              <span className="text-4xl">{typeEmojis[log.log_type]}</span>
              <span className={`ml-2 text-xl font-bold ${styles.text}`}>{typeNames[log.log_type]}</span>
            </div>
