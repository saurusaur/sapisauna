 ...
 *  - 설계 SSOT: docs/wireframes/[final]_스토리_프로토타입_v3_20260609.html · 결정 데모(아카이브): docs/wireframes/archive/스토리_개선제안_데모_20260610.html
 *  - 레이아웃 값 단일 소스: src/lib/story-card-spec.ts (프리뷰·Canvas 공유)
 *
 * v3.6 페이지 크롬 (2026-06-12, 시안 아카이브: docs/wireframes/archive/스토리페이지_리디자인_시안_20260611.html):
